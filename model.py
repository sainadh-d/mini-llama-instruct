...
class Attention(nn.Module):
    ...
    def forward(
        ...
        xq, xk = apply_rotary_embeddings(xq, xk, freqs_cos, freqs_sin)
        ...
        if self.flash:
            ...
            scores = scores + self.mask[:, :, :T, :T]   # (bs, n_local_heads, seqlen, cache_len + seqlen)
...
class Transformer(nn.Module):
    def __init__(self, params: ModelArgs):
        ...
        self.token_embeddings.weight = self.output.weight # https://paperswithcode.com/method/weight-tying
